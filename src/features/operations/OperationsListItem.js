...
export default function OperationsListItem({ itemObj }) {
  ...
  return (
    <ListItem>
      <Grid2 container columnSpacing={1} alignItems='center' justifyContent='space-between' xs={12}>
        <Grid2 item xs={1}>
          <div
            className={type}
        ...
        <Grid2 item xs={6}>
          <ListItemText primary={text} secondary={displayedCategory} sx={{ overflow: 'overlay' }} />
        </Grid2>
        <Grid2 item xs={1}>
          <div
            style={{
