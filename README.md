...
<!-- - сделать страницу error page -->
<!-- - сделать в списке навигации главную страницу наверху -->

- найти библиотеку для графиков
- определиться какие типы аналитики нужны :
- динамика доходов и расходов по месяцам (отдельная страница с фильтром даты)
- динамика расходов по категориям (отдельная страница с фильтром даты)

- сделать сохранение операций в локал сторейдж
